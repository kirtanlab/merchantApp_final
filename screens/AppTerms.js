  ...
  return (
    <ScrollView style={{ backgroundColor: "white", flex: 1, padding: 12 }}>
      ...
      >
        ...
        opinions and information in certain areas of the app. NIVAAS does not
        filter, edit, publish or review Comments prior to their presence on the
        app. Comments do not reflect the views and opinions of NIVAAS,its agents
        ...
        laws, NIVAAS shall not be liable for the Comments or for any liability,
        damages or expenses caused and/or suffered as a result of any use of
        and/or posting of and/or appearance of the Comments on this app.{"\n"}
        {"\n"} NIVAAS reserves the right to monitor all Comments and to remove
        ...
        activity.{"\n"} You hereby grant NIVAAS a non-exclusive license to use,
        ...
        visibility of the hyperlink compensates the absence of NIVAAS; and{"\n"}{" "}
        ...
        inform us by sending an e-mail to NIVAAS. Please include your name, your
        organization name, contact information as well as the URL of your site,
        a list of any URLs from which you intend to link to our App, and a list
        of the URLs on our site to which you would like to link. Wait 2-3 weeks
        for a response. Approved organizations may hyperlink to our App as
        ...
        content on the linking party’s site. No use of NIVAAS's logo or other
